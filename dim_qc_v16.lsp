;;; ============================================================================
;;;  dim_qc_v16.lsp  -  Engineering Dual-Unit QC
;;;  Version 16.0  (MED cross-entity fix; tight ±0.5 tolerance; Notes X-offset balloon)
;;;
;;;  COMMANDS
...
(defun C:DIMQC ( / doc mode result total pass fail skip sumstr)
  ...
  (princ "\n============================================")
  (princ "\n  DIM QC v16.0 - Select Check Mode")
  (princ "\n============================================")
